...
public class FakePlayer extends Module {
	...
	private final BooleanSetting damage = add(new BooleanSetting("Damage"));
	private final BooleanSetting autoTotem = add(new BooleanSetting("AutoTotem"));
	private final BooleanSetting gApple = add(new BooleanSetting("GApple"));
	...
	public void onEnable() {
		...
		fakePlayer = new OtherClientPlayerEntity(mc.world, new GameProfile(UUID.fromString("11451466-6666-6666-6666-666666666600"), "FakePlayer"));
	...
	public void onUpdate() {
		if (fakePlayer != null) {
			...
			if (autoTotem.getValue() && fakePlayer.getOffHandStack().getItem() != Items.TOTEM_OF_UNDYING) {
				Rebirth.POP.onTotemPop(fakePlayer);
